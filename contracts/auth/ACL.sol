...
contract Auth {
    ...
    public onlyProvider isAccessRequested(challenge) returns (bool) {
    ...
    isAccessRequested(challenge) {
        // timeout
        // todo: we should revoke / require here to get the gas back in case of statement not met
    ...
    */
    function verifyJWT(bytes32 challenge, bytes signedEncJWT) private {
        ...
        // verify the consumer's signature (aclEntries[challenge].commetment.encJWT, signedEncJWT,
        // aclEntries[challenge].consumer)
        return true;
    }
